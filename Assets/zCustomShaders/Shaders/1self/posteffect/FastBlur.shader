...
Shader "Hidden/Minimum/Fx/FastBlur" {
    Properties{
    ...
    v2f_withBlurCoords8 vertBlurHorizontal(appdata_img v)
    {
        ...
        o.offs = _MainTex_TexelSize.xy * half2(1.0, 0.0) * offset;
    ...
    v2f_withBlurCoords8 vertBlurVertical(appdata_img v)
    {
        ...
        o.uv = half4(v.texcoord.xy, 1, 1);
        o.offs = _MainTex_TexelSize.xy * half2(0.0, 1.0) * offset;
    ...
    v2f_withBlurCoordsSGX vertBlurHorizontalSGX(appdata_img v)
    {
        ...
        o.uv = v.texcoord.xy;
        half2 netFilterWidth = _MainTex_TexelSize.xy * half2(1.0, 0.0) * offset;
    ...
    v2f_withBlurCoordsSGX vertBlurVerticalSGX(appdata_img v)
    {
        ...
        o.uv = half4(v.texcoord.xy, 1, 1);
        half2 netFilterWidth = _MainTex_TexelSize.xy * half2(0.0, 1.0) * offset;
        half4 coords = -netFilterWidth.xyxy * 3.0;
